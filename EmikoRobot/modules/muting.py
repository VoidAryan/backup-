...
def check_user(user_id: int, bot: Bot, chat: Chat) -> Optional[str]:
    ...
    if user_id == bot.id:
        reply = "I cant mute mmyself! but what happened! tell @voidxtoxic he will fix naa"
        return reply
...
def unmute(update: Update, context: CallbackContext) -> str:
    ...
    if member.status in ("kicked", "left"):
        ...
        message.reply_text("This user already has the right to speak. Now want me to tag and say to chat?")
    else:
