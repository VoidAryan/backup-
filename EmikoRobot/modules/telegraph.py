...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if input_str == "gm":
            ...
            h = await event.reply("Waito Baka im uploading to {} in {} seconds hehe.".format(downloaded_file_name, ms))
            ...
            try:
                ...
                os.remove(downloaded_file_name)
                await h.edit("HuihuiBaka Uploaded to https://telegra.ph{}".format(media_urls[0], (ms + ms_two)), link_preview=True)
        elif input_str == "gt":
